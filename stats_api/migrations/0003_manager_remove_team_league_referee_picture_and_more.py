...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('stats_api', '0002_match_referee_tournament_remove_player_age_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='team',
            name='tournament',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.RESTRICT, related_name='teams', to='stats_api.tournament'),
        ...
        migrations.AddField(
            model_name='team',
            name='manager',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.PROTECT, related_name='teams', to='stats_api.manager'),
            preserve_default=False,
        ),
    ]
